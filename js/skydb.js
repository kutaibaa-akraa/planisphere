...
{pos:{ra:3.837972,dec:-1.061776},label:"رجل قنطورس"},
{pos:{ra:4.873563,dec: 0.676902},label:"النسر الواقع"},
{pos:{ra:1.381821,dec: 0.802818},label:"العيوق"},
{pos:{ra:1.372432,dec:-0.143146},label:"رجل الجبار"},
{pos:{ra:2.004081,dec: 0.091193},label:"الغميصاء"},
{pos:{ra:0.426362,dec:-0.998968},label:"آخر النهر"},
{pos:{ra:1.549729,dec: 0.129276},label:"منكب الجوزاء"},
{pos:{ra:3.681874,dec:-1.053709},label:"حضار"},
{pos:{ra:5.195773,dec: 0.154782},label:"النسر الطائر"},
{pos:{ra:1.203928,dec: 0.288139},label:"الدبران"},
{pos:{ra:4.317101,dec:-0.461324},label:"قلب العقرب"},
{pos:{ra:3.513319,dec:-0.194803},label:"السماك الأعزل"},
{pos:{ra:2.030320,dec: 0.489148},label:"رأس التوأم المؤخر"},
{pos:{ra:6.011139,dec:-0.517005},label:"فم الحوت"},
{pos:{ra:5.416768,dec: 0.790290},label:"ذنب الدجاجة"},
{pos:{ra:3.349810,dec:-1.041763},label:"ميموسا"},
{pos:{ra:3.257650,dec:-1.101288},label:"أكروكس"},
{pos:{ra:2.654522,dec: 0.208867},label:"قلب الأسد"},
{pos:{ra:1.826596,dec:-0.505661},label:"العذارى"},
{pos:{ra:4.597234,dec:-0.647585},label:"الشولة"},
{pos:{ra:1.418655,dec: 0.110824},label:"الناجذ"},
{pos:{ra:1.423716,dec: 0.499295},label:"النطح"},
{pos:{ra:5.795511,dec:-0.819626},label:"النير"},
{pos:{ra:0.891529,dec: 0.870241},label:"المرفق"},
{pos:{ra:2.896061,dec: 1.077755},label:"الدب"},
{pos:{ra:3.610824,dec: 0.860680},label:"القائد"},
{pos:{ra:5.347900,dec:-0.990213},label:"الطاووس"},
{pos:{ra:1.983567,dec: 0.556556},label:"رأس التوأم المقدم"},
{pos:{ra:2.476564,dec:-0.151121},label:"الفرد"},
{pos:{ra:0.554898,dec: 0.409498},label:"الحمل"},
{pos:{ra:4.953528,dec:-0.458963},label:"نونكي"},
{pos:{ra:0.662403,dec: 1.557954},label:"الجدي"},
{pos:{ra:0.190197,dec:-0.313927},label:"الضفدع"},
{pos:{ra:0.036601,dec: 0.507726},label:"سرة الأسد"},
{pos:{ra:4.603022,dec: 0.219213},label:"رأس الجاثي"},
{pos:{ra:0.821039,dec: 0.714809},label:"الغول"},
{pos:{ra:3.093858,dec: 0.254328},label:"ذنب الأسد"},
{pos:{ra:0.176751,dec: 0.986761},label:"الصدر"},
{pos:{ra:4.078347,dec: 0.466260},label:"الفكة"},
{pos:{ra:4.697583,dec: 0.898651},label:"العوائذ"},
{pos:{ra:0.540616,dec: 0.738793},label:"عناق الأرض"},
{pos:{ra:3.507785,dec: 0.958627},label:"المئزر"},
{pos:{ra:0.114683,dec:-0.738381},label:"عنقاء"},
{pos:{ra:6.037858,dec: 0.490137},label:"منكب الفرس"},
{pos:{ra:5.578858,dec: 1.092324},label:"الذراع الأيمن"},
{pos:{ra:6.042162,dec: 0.265382},label:"متن الفرس"}];
...
{pos:{ra:5.148,dec: 0.061},abbrev:"Aql",name:"العقاب"},
{pos:{ra:5.837,dec:-0.188},abbrev:"Aqr",name:"الدلو"},
{pos:{ra:4.552,dec:-0.988},abbrev:"Ara",name:"المجمرة"},
{pos:{ra:0.690,dec: 0.364},abbrev:"Ari",name:"الحمل"},
{pos:{ra:1.592,dec: 0.733},abbrev:"Aur",name:"ممسك الأعنة"},
{pos:{ra:3.852,dec: 0.545},abbrev:"Boo",name:"العواء"},
{pos:{ra:1.788,dec:-0.386},abbrev:"CMa",name:"الكلب الأكبر"},
{pos:{ra:1.970,dec: 0.113},abbrev:"CMi",name:"الكلب الأصغر"},
{pos:{ra:3.433,dec: 0.700},abbrev:"CVn",name:"السلوقيان"},
{pos:{ra:1.232,dec:-0.661},abbrev:"Cae",name:"آلة النقاش"},
{pos:{ra:1.309,dec: 1.187},abbrev:"Cam",name:"الزرافة"},
{pos:{ra:5.511,dec:-0.314},abbrev:"Cap",name:"الجدي"},
{pos:{ra:1.900,dec:-1.000},abbrev:"Car",name:"القاعدة"},
{pos:{ra:0.150,dec: 1.086},abbrev:"Cas",name:"ذات الكرسي"},
{pos:{ra:3.424,dec:-0.828},abbrev:"Cen",name:"قنطورس"},
{pos:{ra:5.890,dec: 1.240},abbrev:"Cep",name:"قيفاوس"},
{pos:{ra:0.400,dec:-0.224},abbrev:"Cet",name:"قيطس"},
{pos:{ra:2.799,dec:-1.386},abbrev:"Cha",name:"الحرباء"},
{pos:{ra:3.817,dec:-1.100},abbrev:"Cir",name:"البيكار"},
{pos:{ra:2.264,dec: 0.390},abbrev:"Cnc",name:"السرطان"},
{pos:{ra:1.536,dec:-0.613},abbrev:"Col",name:"الحمامة"},
{pos:{ra:3.380,dec: 0.465},abbrev:"Com",name:"الهلبة"},
{pos:{ra:4.882,dec:-0.718},abbrev:"CrA",name:"الإكليل الجنوبي"},
{pos:{ra:4.147,dec: 0.569},abbrev:"CrB",name:"الإكليل الشمالي"},
{pos:{ra:2.984,dec:-0.278},abbrev:"Crt",name:"الباطية"},
{pos:{ra:3.259,dec:-1.051},abbrev:"Cru",name:"الصليب الجنوبي"},
{pos:{ra:3.257,dec:-0.322},abbrev:"Crv",name:"الغراب"},
{pos:{ra:5.392,dec: 0.700},abbrev:"Cyg",name:"الدجاجة"},
{pos:{ra:5.418,dec: 0.204},abbrev:"Del",name:"الدلفين"},
{pos:{ra:1.371,dec:-1.036},abbrev:"Dor",name:"أبو سيف"},
{pos:{ra:4.256,dec: 1.057},abbrev:"Dra",name:"التنين"},
{pos:{ra:5.546,dec: 0.135},abbrev:"Equ",name:"قطعة الفرس"},
{pos:{ra:0.863,dec:-0.203},abbrev:"Eri",name:"النهر"},
{pos:{ra:0.732,dec:-0.533},abbrev:"For",name:"الكور"},
{pos:{ra:1.850,dec: 0.394},abbrev:"Gem",name:"التوأمين"},
{pos:{ra:5.880,dec:-0.809},abbrev:"Gru",name:"الكركي"},
{pos:{ra:4.553,dec: 0.482},abbrev:"Her",name:"الجاثي"},
{pos:{ra:0.858,dec:-0.930},abbrev:"Hor",name:"الساعة"},
{pos:{ra:2.730,dec:-0.250},abbrev:"Hya",name:"الشجاع"},
{pos:{ra:0.609,dec:-1.220},abbrev:"Hyi",name:"حية الماء"},
{pos:{ra:5.500,dec:-0.942},abbrev:"Ind",name:"الهندي"},
{pos:{ra:2.682,dec: 0.561},abbrev:"LMi",name:"الأسد الأصغر"},
{pos:{ra:5.880,dec: 0.803},abbrev:"Lac",name:"العظاءة"},
{pos:{ra:2.793,dec: 0.229},abbrev:"Leo",name:"الأسد"},
{pos:{ra:1.457,dec:-0.332},abbrev:"Lep",name:"الأرنب"},
{pos:{ra:3.979,dec:-0.266},abbrev:"Lib",name:"الميزان"},
{pos:{ra:3.985,dec:-0.746},abbrev:"Lup",name:"السبع"},
{pos:{ra:2.093,dec: 0.828},abbrev:"Lyn",name:"الوشق"},
{pos:{ra:4.938,dec: 0.640},abbrev:"Lyr",name:"القيثارة"},
{pos:{ra:1.435,dec:-1.351},abbrev:"Men",name:"الجبل"},
{pos:{ra:5.489,dec:-0.633},abbrev:"Mic",name:"المجهر"},
{pos:{ra:1.850,dec: 0.006},abbrev:"Mon",name:"وحيد القرن"},
{pos:{ra:3.294,dec:-1.225},abbrev:"Mus",name:"الذبابة"},
{pos:{ra:4.160,dec:-0.897},abbrev:"Nor",name:"مربع النجار"},
{pos:{ra:4.000,dec:-1.550},abbrev:"Oct",name:"الثمن"},
{pos:{ra:4.471,dec: 0.084},abbrev:"Oph",name:"الحواء"},
{pos:{ra:1.459,dec: 0.020},abbrev:"Ori",name:"الجبار"},
{pos:{ra:5.136,dec:-1.147},abbrev:"Pav",name:"الطاووس"},
{pos:{ra:6.100,dec: 0.342},abbrev:"Peg",name:"الفرس الأعظم"},
{pos:{ra:0.830,dec: 0.786},abbrev:"Per",name:"حامل رأس الغول"},
{pos:{ra:0.114,dec:-0.847},abbrev:"Phe",name:"العنقاء"},
{pos:{ra:1.495,dec:-0.933},abbrev:"Pic",name:"آلة الرسام"},
...
{pos:{ra:4.889,dec:-0.173},abbrev:"Sct",name:"الترس"},
{pos:{ra:4.400,dec:-0.139},abbrev:"Ser",name:"الحية"},
{pos:{ra:2.689,dec:-0.046},abbrev:"Sex",name:"آلة السدس"},
{pos:{ra:5.145,dec: 0.328},abbrev:"Sge",name:"السهم"},
{pos:{ra:5.000,dec:-0.499},abbrev:"Sgr",name:"الرامي"},
{pos:{ra:1.231,dec: 0.257},abbrev:"Tau",name:"الثور"},
{pos:{ra:5.060,dec:-0.891},abbrev:"Tel",name:"المرقب"},
{pos:{ra:4.207,dec:-1.141},abbrev:"TrA",name:"المثلث الجنوبي"},
{pos:{ra:0.572,dec: 0.549},abbrev:"Tri",name:"المثلث"},
{pos:{ra:6.226,dec:-1.149},abbrev:"Tuc",name:"الطوقان"},
{pos:{ra:2.961,dec: 0.883},abbrev:"UMa",name:"الدب الأكبر"},
{pos:{ra:4.045,dec: 1.453},abbrev:"UMi",name:"الدب الأصغر"},
{pos:{ra:2.507,dec:-0.823},abbrev:"Vel",name:"الشراع"},
{pos:{ra:3.510,dec:-0.072},abbrev:"Vir",name:"العذراء"},
{pos:{ra:2.043,dec:-1.219},abbrev:"Vol",name:"السمكة الطائرة"},
{pos:{ra:5.296,dec: 0.427},abbrev:"Vul",name:"الثعلب"}]
...
{pos: {ra: 0, dec: 0}, name: "الزهرة", color: "#FFFFFF",
